...
```bash
git clone https://github.com/alexbalut/bcycle-gym-qr-guide.git
...
Credentials: `admin@bcycle.demo` / `demo1234`
...
Seed **wipes** gyms, users, machines, and issues, then recreates b.cycle Montreal with 10 machines and sample issues/views.
